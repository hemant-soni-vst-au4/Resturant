...
const menu = () => {
    ...
    let section_div_div1_img = section_div_div.appendChild(document.createElement("img"))
    ...
    let section_div_div2_img = section_div_div.appendChild(document.createElement("img"))
    ...
    let section_div_div3_img = section_div_div.appendChild(document.createElement("img"))
